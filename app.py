...
def _build_background_layer_html() -> str:
    return _html_block(
        """
        <style>
        .pf-bg-layer{position:fixed;inset:0;z-index:0;overflow:hidden;pointer-events:none;background:linear-gradient(135deg,rgba(255,255,255,.78),rgba(248,251,255,.56));-webkit-transform:translateZ(0);transform:translateZ(0)}
        .pf-bubble{position:absolute;width:var(--s);height:var(--s);left:var(--x);top:var(--y);border-radius:50%;opacity:var(--o,.18);will-change:transform,border-radius;background:radial-gradient(circle at 30% 25%,rgba(255,255,255,.92) 0 9%,rgba(255,255,255,.38) 10% 18%,var(--c) 45%,rgba(255,255,255,0) 76%);box-shadow:inset -24px -28px 46px rgba(20,33,62,.13),inset 18px 20px 38px rgba(255,255,255,.52),0 18px 44px rgba(44,62,98,.09)}
        .pf-bubble::before{content:"";position:absolute;inset:14% 20% auto auto;width:28%;height:18%;border-radius:50%;background:rgba(255,255,255,.55);-webkit-filter:blur(6px);filter:blur(6px);transform:rotate(-24deg)}
        ...
        .pf-collision-wave{position:absolute;left:var(--x);top:var(--y);width:var(--s);height:var(--s);border-radius:50%;border:1px solid var(--c);opacity:0;transform:translate(-50%,-50%) scale(.25);will-change:transform,opacity}
